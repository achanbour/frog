func.func @mykernel(%myvar3:tensor<6xf64>, %myvar4:tensor<6xf64>, %out:tensor<6xf64>)
{
    // Mykernel args:
        // myvar3: local basis coefficients of the function 
        // myvar4: vertex coordinates of the ref. triangle
        // out: output vector


    // Local basis functions at the quadrature points
    ...
    gpu.launch 
        blocks(%bx, %by, %bz) in (%grid_x = %c1, %grid_y = %c1, %grid_z = %c1)
